...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-26 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 flex flex-col gap-4">
          ...
          <p className="text-xl text-gray-600 max-w-5xl mx-auto">
            Ponte en contacto con nuestro equipo para aprender cómo Zonda Health
            puede ayudarte a brindar mejor atención al paciente a través de
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 mb-1">{contactInfo.details}</p>
